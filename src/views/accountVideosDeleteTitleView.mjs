...
const accountVideosDeleteTitleView = (dynamicValues) =>
    {
        ...
        const template =
`
        <title>${i18n.__('Delete')} ${title} — ${i18n.__('My videos')} — ${myAccount} — ${siteName}</title>
...
export default accountVideosDeleteTitleView;
